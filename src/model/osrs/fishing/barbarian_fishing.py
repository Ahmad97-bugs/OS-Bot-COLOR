...
class OSRSBarbFisher(OSRSBot):
    ...
    def main_loop(self):
        ...
        while time.time() - start_time < end_time:
            ...
            if not self.mouseover_text(contains="Use-rod", color=clr.OFF_WHITE) and not self.__move_mouse_to_nearest_spot():
                failed_searches += 1
            ...
            if not self.mouseover_text(contains="Use-rod", color=clr.OFF_WHITE):
                continue
            self.mouse.click()
            time.sleep(5)
